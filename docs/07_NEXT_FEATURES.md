...
| 기능 | 현재 봇 | 목표 봇 | 스레드 | 상태 |
|------|---------|---------|--------|------|
| 온보딩 / 설정 / 전체 조율 | bot.py | bot.py (관리봇) | — | ✅ 운영 중 |
| 식사 입력 / 칼로리 분석 | bot.py | bot_meal.py | 식사 기록 | ✅ 구현 완료 / 분리 예정 |
| 날씨 / 미세먼지 알림 | bot.py | bot_weather.py | 날씨 | ✅ 구현 완료 / 분리 예정 |
| 체중 기록 + 칼로리 목표 관리 | bot.py | bot_weight.py | 체중관리 | ✅ 구현 완료 / 분리 + 확장 예정 |
| 스트릭 / 배지 / 주간 리포트 | bot.py | 미정 | — | ✅ 구현 완료 |
| 이메일 모니터링 | bot_mail.py | bot_mail.py | 메일함 | ✅ v3.1 완료 |
| 음식 추천 (n8n) | bot.py | bot.py | — | 🔧 준비 중 (n8n 연동 대기) |
| 일기 / 감정 분석 | — | bot_diary.py | 일기장 | 📋 설계 예정 |
| 일정 / 캘린더 / 알림 | — | bot_schedule.py | 일정표 | 📋 설계 예정 |
