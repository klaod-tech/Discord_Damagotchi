"""
utils/weight_ui.py — 체중관리 공통 UI / DB 헬퍼
────────────────────────────────────────────────────────────────
bot_weight.py (체중관리봇)과 utils/embed.py (버튼 핸들러) 양쪽에서 공유.
cogs/weight.py 는 WeightCog 껍데기만 남기고, 실제 로직은 여기에 위치.
────────────────────────────────────────────────────────────────
"""

import discord

from utils.db import get_conn, get_user, get_tamagotchi
